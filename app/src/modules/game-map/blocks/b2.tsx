...
export function B2({offset}: {offset: number}) {
  return (
    <group position={[30 * offset, 0, 30 * offset]}>
      ...
      <Unit x={6} z={4} color={0xffffff} />
      <Unit x={7} z={4} color={0xdddddd} />
      <Unit x={8} z={4} color={0xffffff} />
      <Unit x={9} z={4} color={0xdddddd} />
      <Unit x={4} z={5} color={0xdddddd} />
      <Unit x={5} z={5} color={0xffffff} />
      <Unit x={6} z={5} color={0xdddddd} />
      <Unit x={7} z={5} color={0xffffff} />
      <Unit x={8} z={5} color={0xdddddd} />
      <Unit x={9} z={5} color={0xffffff} />
    </group>
  );
}
